...
public class TitanElectricoHealthBar : MonoBehaviour
{
    [Header("Referencia al Titán Eléctrico")]
    public TitanElectrico titan;
    ...
    public string titanName = "TITÁN ELÉCTRICO";
